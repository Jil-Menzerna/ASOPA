...
def get_options(args=None):
    ...
    parser.add_argument('--embedding_dim', type=int, default=128, help='Dimension of input embedding, default 128')
    parser.add_argument('--hidden_dim', type=int, default=128, help='Dimension of hidden layers in Enc/Dec, default 128')
    parser.add_argument('--n_encode_layers', type=int, default=3,
                        help='Number of layers in the encoder/critic network, default 3')
    ...
    # Training
    lr = 1e-4 # 1e-4
    parser.add_argument('--lr_model', type=float, default=lr, help="Set the learning rate for the actor network 1e-4")
