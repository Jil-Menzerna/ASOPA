...
parser.add_argument('--val_user_num',default=10,help='用户数')
# 1,2,1,10
...
parser.add_argument('--num_min',default=5,help='用户的最小吞吐量权重') #1,5
parser.add_argument('--num_max',default=10,help='用户最大的吞吐量权重')
